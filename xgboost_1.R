...
# preProc <- preProcess(train[feature.names], method = c("range"))
# train[feature.names] = predict(preProc, train[feature.names])
# test[feature.names] = predict(preProc, test[feature.names])
...
write_csv(submission, "xgboost_submission_55.csv")